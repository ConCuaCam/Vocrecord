        					...
        					<div class="box-content">
        						...
        						<table>
        							...
        							<tbody>
        								...
        								<tr>
        									<td class="product-remove"><a href="FuncWishlistController?action=del&id=<%=h.getMadia()%>">×</a></td>
        									<td class="product-img"><a href="ChiTietController?md=<%=h.getMadia()%>"><img src="<%=h.getAnh() %>"></a></td>
        									<td class="product-name"><a href="ChiTietController?md=<%=h.getMadia()%>"><%=h.getNghesi() %> - <%=h.getTendia() %></a></td>
        								</tr>
        								<%} %>
        							</tbody>
        						</table>
